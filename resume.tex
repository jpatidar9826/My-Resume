...
\section{Projects}
  \resumeHeadingListStart{}
    \resumeTrioHeading{\href{https://my-college-project-site.onrender.com/}{\uline{Resume Builder Web Application}}}{HTML, CSS, JavaScript, Bootstrap, Node.js, MongoDB.}{\href{https://github.com/jpatidar9826/Cproject2}{\uline{Source Code}}}
      \resumeItemListStart{}
        \resumeItem{Designed and developed a clean and modern MVC WebApp using \textbf{HTML, CSS, JavaScript, Bootstrap, Node.js, MongoDB}}
        ...
        \resumeItem{Maintained code with \textbf{Github} and deployed on Render. {\href{https://raysume-react-app.onrender.com/}{\uline{Version 2 in development}}}}
      \resumeItemListEnd{}
      ...
      \resumeItemListStart{}
        \resumeItem{Versatile bot proficient in delivering witty, sarcastic replies to tweets using \textbf{OpenAI API}, sharing entertaining jokes using \textbf{Jokes API}, and providing interactive Twitter support with screenshot sharing using \textbf{Puppeteer}.}
        \resumeItem{Maintained code with \textbf{Github} and tested with \textbf{Postman.}}
      \resumeItemListEnd{}
  \resumeHeadingListEnd{}
%--------------------------------------------
